...
[IO.File]::WriteAllText((Join-Path $composeDir 'docker-compose.prefix-priority.yml'), $out, $enc)
Write-Host "Wrote compose/docker-compose.prefix-priority.yml" -ForegroundColor Green
